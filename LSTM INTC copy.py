...
def get_stock_data(stock_name, normalized = 0):
    url = 'http://chart.finance.yahoo.com/table.csv?s=%s&a=11&b=15&c=2007&d=29&e=10&f=2016&g=d&ignore=.csv' % stock_name
...
def load_data(stock, seq_len):
    ...
    x_train = np.reshape(x_train, (x_train.shape[0], x_train.shape[1], ammont_of_features))
    x_test = np.reshape(x_test, (x_test.shape[0], x_test.shape[1], ammont_of_features))
...
model.save(('%s_model.h5' % stock_name))
